...
/**
 * Mapper class used to transform {@link com.tribe.app.data.realm.WeatherRealm} (in the data layer) to {@link com.tribe.app.domain.entity.Weather} in the
 * domain layer.
 */
@Singleton
public class WeatherRealmDataMapper {
     ...
     * @return {@link com.tribe.app.domain.entity.Weather} if valid {@link com.tribe.app.data.realm.WeatherRealm} otherwise null.
     */
