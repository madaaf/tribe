...
/**
 * Mapper class used to transform {@link com.tribe.app.data.realm.MembershipRealm} (in the data layer) to {@link com.tribe.app.domain.entity.Membership} in the
 * domain layer.
 */
@Singleton
public class MembershipRealmDataMapper {
     ...
     * @return {@link com.tribe.app.domain.entity.Membership} if valid {@link com.tribe.app.data.realm.MembershipRealm} otherwise null.
     */
     ...
     */
    public RealmList<MembershipRealm> transformMemberships(Collection<Membership> membershipCollection) {
