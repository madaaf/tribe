...
@Singleton public class ShortcutRealmDataMapper {
  ...
  public Shortcut transform(ShortcutRealm shortcutRealm) {
    ...
    if (shortcutRealm != null) {
      ...
      shortcut.setMembers(userRealmDataMapper.transform(shortcutRealm.getMembers(), true));
  ...
  public ShortcutRealm transform(Shortcut shortcut) {
    ...
    if (shortcut != null) {
      ...
      shortcutRealm.setMembers(userRealmDataMapper.transformList(shortcut.getMembers(), true));
