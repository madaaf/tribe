 ...
 */
public class OtherHeaderMessageAdapterDelegate extends HeaderMessageAdapterDelegate {

    public OtherHeaderMessageAdapterDelegate(LayoutInflater inflater, Context context) {
