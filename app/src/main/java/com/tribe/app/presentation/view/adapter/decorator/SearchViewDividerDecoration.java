...
public class SearchViewDividerDecoration extends RecyclerView.ItemDecoration {

  private final Paint paint;
  private int heightDp;
  private SectionCallback sectionCallback;

  public SearchViewDividerDecoration(Context context, int color, float heightDp,
  ...
  private boolean hasDividerOnBottom(View view, RecyclerView parent, RecyclerView.State state) {
    ...
    return position < state.getItemCount() - 1 && !sectionCallback.isSection(position + 1);
  }
