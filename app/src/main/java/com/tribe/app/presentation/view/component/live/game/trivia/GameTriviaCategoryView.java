...
public class GameTriviaCategoryView extends LinearLayout {
  ...
  public GameTriviaCategoryView(@NonNull Context context) {
    super(context);
  }

  public GameTriviaCategoryView(@NonNull Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
