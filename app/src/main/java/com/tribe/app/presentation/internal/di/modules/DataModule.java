...
@Module public class DataModule {
  ...
  @Provides @Singleton @DistanceUnits Preference<String> provideDistanceUnits(
      RxSharedPreferences prefs) {
    return prefs.getString(PreferencesConstants.DISTANCE_UNITS, Distance.METERS);
  }

  @Provides @Singleton @WeatherUnits Preference<String> provideWeatherUnits(
      RxSharedPreferences prefs) {
    return prefs.getString(PreferencesConstants.WEATHER_UNITS,
        com.tribe.app.presentation.view.utils.Weather.CELSIUS);
  }

  @Provides @Singleton @Memories Preference<Boolean> provideMemories(RxSharedPreferences prefs) {
    return prefs.getBoolean(PreferencesConstants.MEMORIES, false);
  }

  @Provides @Singleton @LocationContext Preference<Boolean> provideLocationContext(
      RxSharedPreferences prefs) {
    return prefs.getBoolean(PreferencesConstants.LOCATION_CONTEXT, true);
  }

  @Provides @Singleton @AudioDefault Preference<Boolean> provideAudioDefault(
      RxSharedPreferences prefs) {
  ...
  @Provides @Singleton @LastUserRequest Preference<String> provideLastUserRequest(
      RxSharedPreferences prefs) {
    return prefs.getString(PreferencesConstants.LAST_USER_REQUEST, "");
  }

  @Provides @Singleton @LastNotifyRequest Preference<String> provideLastFBNotify(
      RxSharedPreferences prefs) {
    return prefs.getString(PreferencesConstants.LAST_NOTIFY_REQUEST, "");
  }

  @Provides @Singleton @Filter Preference<Integer> provideFilter(RxSharedPreferences prefs) {
    return prefs.getInteger(PreferencesConstants.FILTER, 0);
  }

  @Provides @Singleton @ShareProfile Preference<Boolean> provideShareProfile(
      RxSharedPreferences prefs) {
  ...
  @Provides @Singleton @HasReceivedPointsForCameraPermission
  ...
  @Provides @Singleton @WasAskedForPermissions
  ...
  @Provides @Singleton @HasRatedApp Preference<Boolean> provideHasRatedApp(
      RxSharedPreferences prefs) {
  ...
  @Provides @Singleton @LastOnlineNotification Preference<Long> provideLastOnlineNotification(
      RxSharedPreferences prefs) {
