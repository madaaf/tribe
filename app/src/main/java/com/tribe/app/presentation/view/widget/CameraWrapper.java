...
public class CameraWrapper extends CardView {
  ...
  @StringDef({ VIDEO, AUDIO, PHOTO }) public @interface TribeMode {
  }
  ...
  @BindView(R.id.imgSound) View imgSound;

  @BindView(R.id.imgFlash) View imgFlash;

  @BindView(R.id.imgVideo) View imgVideo;

  @BindView(R.id.viewGradient) View viewGradient;

  @BindView(R.id.viewCameraForeground) View viewCameraForeground;

  @BindView(R.id.layoutCameraPermissions) ViewGroup layoutCameraPermissions;

  @BindView(R.id.visualizerView) PictoVisualizerView visualizerView;
  ...
  // RESOURCES
  private int marginTopInit, marginLeftInit, marginBottomInit, marginVerticalIcons,
      marginHorizontalIcons, diffTouch, marginTopBounds, marginLeftBounds, marginBottomBounds;
  ...
  public CameraWrapper(Context context, AttributeSet attrs) {
    ...
    cameraHeight = a.getDimensionPixelSize(R.styleable.CameraWrapper_cameraHeight,
        ViewGroup.LayoutParams.MATCH_PARENT);
    cameraWidth = a.getDimensionPixelSize(R.styleable.CameraWrapper_cameraWidth,
        ViewGroup.LayoutParams.MATCH_PARENT);
  ...
  public void initDimens(int marginTopInit, int marginLeftInit, int marginBottomInit,
    ...
    marginHorizontalIcons =
        getContext().getResources().getDimensionPixelOffset(R.dimen.horizontal_margin);
    marginVerticalIcons =
        getContext().getResources().getDimensionPixelOffset(R.dimen.vertical_margin);
  ...
  @OnClick(R.id.imgSound) public void activateSound() {
    isAudioMode = true;
    tribeMode = AUDIO;
  ...
  @OnClick(R.id.imgVideo) public void activateVideo() {
    isAudioMode = false;
    tribeMode = VIDEO;
  ...
  @OnClick(R.id.layoutCameraPermissions) public void askForPermissions() {
  ...
  public void updateFilter() {
    if (preview != null) {
      if (filter.get() == 3) {
        ...
        if (filter.get().equals(0)) {
          resourceFilter = R.drawable.video_filter_punch;
