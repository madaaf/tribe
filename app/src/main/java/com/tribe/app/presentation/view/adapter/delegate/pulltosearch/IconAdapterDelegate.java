...
public class IconAdapterDelegate extends RxAdapterDelegate<List<FilterEntity>> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent) {
        RecyclerView.ViewHolder vh = new IconViewHolder(layoutInflater.inflate(R.layout.item_pts_icon, parent, false));
        return vh;
    }
    ...
    static class IconViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.imgIcon) public ImageView imgIcon;
