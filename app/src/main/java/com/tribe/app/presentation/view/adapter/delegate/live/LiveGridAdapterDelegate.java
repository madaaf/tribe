...
public class LiveGridAdapterDelegate extends RxAdapterDelegate<List<UserLive>> {
  ...
  @Override public boolean isForViewType(@NonNull List<UserLive> items, int position) {
    return true;
  }
  ...
  @Override public void onBindViewHolder(@NonNull List<UserLive> items, int position,
  ...
  @Override public void onBindViewHolder(@NonNull List<UserLive> items,
