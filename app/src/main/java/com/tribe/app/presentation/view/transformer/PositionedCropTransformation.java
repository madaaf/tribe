...
public class PositionedCropTransformation extends BitmapTransformation {
  ...
  @SuppressWarnings("PMD.CompareObjectsWithEquals") @Override protected Bitmap transform(
  ...
  @Override public String getId() {
    return "PositionedCropTransformation.com.bumptech.glide.load.resource.bitmap.x:" +
        xPercentage +
        ".y:" +
        yPercentage;
  }
