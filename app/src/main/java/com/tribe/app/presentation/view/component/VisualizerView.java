...
public class VisualizerView extends FrameLayout {
    ...
    private void init() {
        ...
        circleViewInside.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.scale_sound_small));
        circleViewOutside.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.scale_sound));
    }
...
//            tempWidth  += screenUtils.dpToPx(10f);
        ...
        if (Math.abs(radiusLarge - this.radiusLarge) >= screenUtils.dpToPx(2.5f)) {
            ...
            if (shouldMultiply) widthTarget = (int) (this.radiusLarge * randomFloat(1.5f, 2.0f));
