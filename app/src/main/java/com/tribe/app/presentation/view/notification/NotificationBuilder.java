...
public class NotificationBuilder {
  ...
  //}
  //
  //private NotificationBuilder(Context context, NotificationManagerCompat notificationManager,
  //    SharedPreferences sharedPreferences) {
  ...
  //  return new NotificationCompat.Builder(context).setContentTitle(message.sender())
