...
public class BlockedFriendAdapterDelegate extends AddAnimationAdapterDelegate<List<Friendship>> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent) {
        RecyclerView.ViewHolder vh = new BlockFriendViewHolder(layoutInflater.inflate(R.layout.item_search, parent, false));
    ...
    public void onBindViewHolder(@NonNull List<Friendship> items, int position, @NonNull RecyclerView.ViewHolder holder) {
        ...
        if (!StringUtils.isEmpty(friendship.getProfilePicture())) {
            Glide.with(context).load(friendship.getProfilePicture())
                    .thumbnail(0.25f)
