...
public class CameraUtils {
  ...
  /**
   * Attempts to find a preview size that matches the provided width and getHeightOb (which
  ...
  @TargetApi(Build.VERSION_CODES.LOLLIPOP) public static boolean hasCamera2(Context context) {
