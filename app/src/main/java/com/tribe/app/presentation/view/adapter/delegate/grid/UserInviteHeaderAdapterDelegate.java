...
public class UserInviteHeaderAdapterDelegate extends RxAdapterDelegate<List<Recipient>> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent) {
        UserInviteHeaderViewHolder userInviteHeaderViewHolder = new UserInviteHeaderViewHolder(layoutInflater.inflate(R.layout.item_live_invite, parent, false));
        userInviteHeaderViewHolder.btnInvite.setOnClickListener(v -> click.onNext(userInviteHeaderViewHolder.itemView));
