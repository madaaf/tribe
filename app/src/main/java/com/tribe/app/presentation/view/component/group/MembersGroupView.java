...
public class MembersGroupView extends FrameLayout {
  ...
  private void init() {
    ...
    recyclerView.addItemDecoration(
        new DividerFirstLastItemDecoration(screenUtils.dpToPx(5), screenUtils.dpToPx(5), 0));
    ...
    subscriptions.add(adapter.longClick()
        ...
        .flatMap(
            groupMember -> DialogFactory.showBottomSheetForGroupMembers(getContext(), groupMember),
