...
@Singleton public class StateManager {
  ...
  @StringDef({
      ...
      FACEBOOK_CONTACT_PERMISSION, REPORT_USER, FIRST_CHALLENGE_POPUP, FIRST_LEAVE_ROOM, FIRST_POKE,
      FIRST_SWIPE_GAME_STORE
  ...
  public static final String FIRST_POKE = "FIRST_POKE";
  public static final String FIRST_SWIPE_GAME_STORE = "FIRST_SWIPE_GAME_STORE";
