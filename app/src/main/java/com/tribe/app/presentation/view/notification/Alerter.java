...
/**
 * Created by madaaflak on 17/02/2017.
 */
...
public final class Alerter {
  ...
  private static void clearCurrent(@NonNull final Activity activity) {
    ...
    try {
      final View alertView =
          activity.getWindow().getDecorView().findViewById(R.id.flAlertBackground);
  ...
  public Alerter setActionButton1(View.OnClickListener onClickListener) {
    getAlert().getButton1().setOnClickListener(onClickListener);
    return this;
  }

  public Alerter setActionButton2(View.OnClickListener onClickListener) {
    getAlert().getButton2().setOnClickListener(onClickListener);
    return this;
  }
  ...
  public Alerter setBackgroundColor(@ColorRes final int colorResId) {
    if (getAlert() != null && getActivityWeakReference() != null) {
      getAlert().setAlertBackgroundColor(
          ContextCompat.getColor(getActivityWeakReference().get(), colorResId));
    }
