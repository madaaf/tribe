...
public class AspectRatio implements Comparable<AspectRatio>, Parcelable {
  ...
  @Override public int compareTo(@NonNull AspectRatio another) {
    if (equals(another)) {
      return 0;
  ...
  public static final Parcelable.Creator<AspectRatio> CREATOR =
      new Parcelable.Creator<AspectRatio>() {
        ...
        @Override public AspectRatio createFromParcel(Parcel source) {
          int x = source.readInt();
          int y = source.readInt();
          return AspectRatio.of(x, y);
        }

        @Override public AspectRatio[] newArray(int size) {
