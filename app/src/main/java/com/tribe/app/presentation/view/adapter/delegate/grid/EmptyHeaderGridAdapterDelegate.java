...
public class EmptyHeaderGridAdapterDelegate extends RxAdapterDelegate<List<Recipient>> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent) {
        return new EmptyHeaderGridViewHolder(layoutInflater.inflate(R.layout.item_empty_header_grid, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull List<Recipient> items, int position, @NonNull RecyclerView.ViewHolder holder) {
        EmptyHeaderGridViewHolder vh = (EmptyHeaderGridViewHolder) holder;
    }
