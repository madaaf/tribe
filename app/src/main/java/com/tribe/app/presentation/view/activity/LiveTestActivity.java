...
public class LiveTestActivity extends BaseActivity {
  ...
  @Inject LiveGridAdapter liveGridAdapter;
  ...
  @OnClick(R.id.imgAdd) void onAdd() {
  ...
  private void refactorPositionInGrid(int position, UserLive userLive) {
    if (position == 3
        || position == 5
        || position == 7) { // The 4th and the 6th live feed go right next to the 0
      userLiveList.add(1, userLive);
    } else if (position == 4
        || position == 6) { // The 5th and 7th live feed go right below to the 0
