...
public abstract class ScalableTextureView extends TextureView {
  ...
  @IntDef({ TOP, BOTTOM, FILL, CENTER_CROP, CENTER_CROP_FILL }) public @interface ScaleVideoType {
  }
  ...
  @Override protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    if (SHOW_LOGS) {
      Log.v(TAG,
          "onMeasure, mContentWidth " + mContentWidth + ", mContentHeight " + mContentHeight);
    }
  ...
  public void updateTextureViewSize() {
    ...
    if (SHOW_LOGS) {
      Log.v(TAG, "updateTextureViewSize, mContentWidth "
          + mContentWidth
          + ", mContentHeight "
          + mContentHeight
          + ", mScaleType "
  ...
  private void updateMatrixScaleRotate() {
    if (SHOW_LOGS) {
      Log.d(TAG, ">> updateMatrixScaleRotate, mContentRotation "
          + mContentRotation
    ...
    mTransformMatrix.setScale(mContentScaleX * mContentScaleMultiplier,
        mContentScaleY * mContentScaleMultiplier, mPivotPointX, mPivotPointY);
  ...
  @Override public void setRotation(float degrees) {
    if (SHOW_LOGS) {
  ...
  @Override public void setPivotX(float pivotX) {
    if (SHOW_LOGS) Log.d(TAG, "setPivotX, pivotX " + pivotX);

    mPivotPointX = pivotX;
  }

  @Override public void setPivotY(float pivotY) {
    if (SHOW_LOGS) Log.d(TAG, "setPivotY, pivotY " + pivotY);

    mPivotPointY = pivotY;
  }

  @Override public float getPivotX() {
    return mPivotPointX;
  }

  @Override public float getPivotY() {
    return mPivotPointY;
  }

  public float getContentAspectRatio() {
    return mContentWidth != null && mContentHeight != null ? (float) mContentWidth
  ...
  public void centralizeContent() {
    ...
    if (SHOW_LOGS) {
      Log.d(TAG, "centralizeContent, measuredWidth "
          + measuredWidth
          + ", measuredHeight "
          + measuredHeight
          + ", scaledContentWidth "
