...
public class NewGameActivityToDelete extends BaseActivity {

  public static Intent getCallingIntent(Context context) {
    Intent intent = new Intent(context, NewGameActivityToDelete.class);
    return intent;
  }
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_new_game_old);
