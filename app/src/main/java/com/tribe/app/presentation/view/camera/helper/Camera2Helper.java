...
@TargetApi(Build.VERSION_CODES.LOLLIPOP) public class Camera2Helper implements CameraHelper {
  ...
  private PictureCaptureCallback captureCallback = new PictureCaptureCallback() {
    ...
    @Override public void onPrecaptureRequired() {
  ...
  private void startCaptureSession() {
    ...
    try {
      ...
      camera.createCaptureSession(Arrays.asList(surface, imageReader.getSurface()), sessionCallback,
          null);
    } catch (CameraAccessException e) {
  ...
  private void prepareImageReader() {
    ...
    imageReader = ImageReader.newInstance(largest.getWidth(), largest.getHeight(), ImageFormat.JPEG, /* maxImages */
        2);
