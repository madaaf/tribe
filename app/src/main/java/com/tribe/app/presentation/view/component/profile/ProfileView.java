...
public class ProfileView extends FrameLayout {
    ...
    @BindView(R.id.viewActionVisible)
    ...
    private void initUI() {
        ...
        viewActionProfile.setTitle(EmojiParser.demojizedText(getContext().getString(R.string.profile_user_infos)));
        viewActionFollow.setTitle(EmojiParser.demojizedText(getContext().getString(R.string.profile_follow_us)));
        viewActionRateUs.setTitle(EmojiParser.demojizedText(getContext().getString(R.string.profile_rate_us)));
        viewActionLogout.setTitle(EmojiParser.demojizedText(getContext().getString(R.string.profile_logout)));
        viewActionVisible.setTitle(EmojiParser.demojizedText(getContext().getString(R.string.profile_invisible_mode)));
    }
