...
public class ShareDialogProfileFragment extends BaseDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View fragmentView = inflater.inflate(R.layout.dialog_fragment_share_profile, container, false);
    ...
    private void prepareShareHandle(String selectedPackage) {
        Observable.just("")
                .map(s -> {
                    ...
                    File file = FileUtils.bitmapToFilePublic("" + System.currentTimeMillis() + ".jpg", shareBitmap, getContext());
