...
public class LabelType implements Serializable {
    ...
    @StringDef({SET_AS_ADMIN, REMOVE_FROM_GROUP, REMOVE_FROM_ADMIN, BLOCK, CANCEL, OPEN_CAMERA, OPEN_PHOTOS,
            CLEAR_MESSAGES, HIDE, BLOCK_HIDE, GROUP_INFO, GROUP_LEAVE, TRIBE_SAVE, TRIBE_INCREASE_SPEED, TRIBE_DECREASE_SPEED, UNHIDE})
