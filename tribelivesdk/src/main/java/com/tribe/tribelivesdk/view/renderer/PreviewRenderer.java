package com.tribe.tribelivesdk.view.renderer;
...
import com.tribe.tribelivesdk.view.gles.GlSurfaceTexture;
import com.tribe.tribelivesdk.view.gles.PreviewTextureInterface;
...
public class PreviewRenderer extends GlFrameBufferObjectRenderer
  ...
  @NonNull private final ArrayList<Runnable> nextTextureImageReadyRunnables;
  @NonNull private final ArrayList<Runnable> onTextureImageReadyRunnables;
  ...
  public void onStartPreview(@NonNull final Cam camera, final boolean faceMirror) {
    ...
    mainHandler.post(() -> rendererCallback.onStartPreviewFinished());
  }
