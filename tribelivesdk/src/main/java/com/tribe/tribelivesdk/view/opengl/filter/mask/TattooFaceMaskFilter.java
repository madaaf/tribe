...
public class TattooFaceMaskFilter extends FaceMaskFilter {

  public TattooFaceMaskFilter(Context context, @FaceMaskFilterType String id, String name,
  ...
  public void computeMask(String path, boolean isFrontFacing) {
    new Thread(() -> {
      String tattooFace = path + "tattoo_mask.png";
