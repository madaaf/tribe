...
public class FrameRendererBlur extends FrameRendererDrawOrigin {
  ...
  @Override public boolean init(boolean isExternalOES) {
    ...
    final String fshBlurExtOES = (isExternalOES ? REQUIRE_STRING_EXTERNAL_OES : "") +
        String.format(fshBlur, isExternalOES ? SAMPLER2D_VAR_EXTERNAL_OES : SAMPLER2D_VAR);
  ...
  @Override public void release() {
    if (mProgramDrawCache != mProgram) mProgramDrawCache.release();
    super.release();
  ...
  protected void resetCacheTexture() {
    ...
    GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_RGBA, mCacheTexWidth, mCacheTexHeight, 0,
