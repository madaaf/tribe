...
public class ExifUtils {
    ...
    public static void save(final String filename, @Nullable final Date datetime, final int orientation, @Nullable
    final Boolean flash, @Nullable final Location location) throws IOException {
        final ExifInterface exif = new ExifInterface(filename);
