...
public class DefaultContextFactory implements GLSurfaceView.EGLContextFactory {
  ...
  @Override public EGLContext createContext(@NonNull final EGL10 egl, final EGLDisplay display,
  ...
  @Override public void destroyContext(@NonNull final EGL10 egl, final EGLDisplay display,
