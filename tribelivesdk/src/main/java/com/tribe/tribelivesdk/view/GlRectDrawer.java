 ...
 * cropping is specified using a 4x4 texture coordinate transform matrix. The frame input can
 * either
...
public class GlRectDrawer implements RendererCommon.GlDrawer {
   ...
   */
  @Override public void drawOes(int oesTextureId, float[] texMatrix, int frameWidth,
   ...
   */
  @Override public void drawRgb(int textureId, float[] texMatrix, int frameWidth, int frameHeight,
   ...
   * allocated at the first call to this function.
   */
  @Override public void drawYuv(int[] yuvTextures, float[] texMatrix, int frameWidth,
      int frameHeight, int viewportX, int viewportY, int viewportWidth, int viewportHeight) {
