...
@SuppressWarnings("deprecation") public class Camera1Enumerator implements CameraEnumerator {
  ...
  @Override public boolean isFrontFacing(String deviceName) {
  ...
  @Override public boolean isBackFacing(String deviceName) {
    android.hardware.Camera.CameraInfo info = getCameraInfo(getCameraIndex(deviceName));
    return info != null && info.facing == android.hardware.Camera.CameraInfo.CAMERA_FACING_BACK;
  }

  @Override public List<CaptureFormat> getSupportedFormats(String deviceName) {
