...
public class RendererCommon {
  ...
  public static class YuvUploader {
    ...
    public int[] uploadYuvData(int width, int height, int[] strides, ByteBuffer[] planes) {
      ...
      if (copyCapacityNeeded > 0 && (copyBuffer == null
          || copyBuffer.capacity() < copyCapacityNeeded)) {
      ...
      for (int i = 0; i < 3; ++i) {
        ...
        if (strides[i] == planeWidths[i]) {
          ...
          LibYuvConverter.nativeCopyPlane(planes[i], planeWidths[i], planeHeights[i], strides[i],
              copyBuffer, planeWidths[i]);
  ...
  public static class VideoLayoutMeasure {
    ...
    public void setScalingType(ScalingType scalingTypeMatchOrientation,
    ...
    public Point measure(int widthSpec, int heightSpec, int frameWidth, int frameHeight) {
      ...
      final ScalingType scalingType =
          (frameAspect > 1.0f) == (displayAspect > 1.0f) ? scalingTypeMatchOrientation
   ...
   */
  public static float[] getLayoutMatrix(boolean mirror, float videoAspectRatio,
