...
/**
 * TribeAudioManager manages all audio related parts of the AppRTC demo.
 */
@Singleton public class TribeAudioManager {

  private static final String TAG = "TribeAudioManager";
  ...
  private void onProximitySensorChangedState() {
    ...
    if (audioDevices.size() == 2
        && audioDevices.contains(TribeAudioManager.AudioDevice.EARPIECE)
        && audioDevices.contains(TribeAudioManager.AudioDevice.SPEAKER_PHONE)) {
      if (proximitySensor.sensorReportsNearState()) {
        // Sensor reports that a "handset is being held up to a person's ear",
        // or "something is covering the light sensor".
        setAudioDeviceInternal(TribeAudioManager.AudioDevice.EARPIECE);
      } else {
        // Sensor reports that a "handset is removed from a person's ear", or
        // "the light sensor is no longer covered".
        setAudioDeviceInternal(TribeAudioManager.AudioDevice.SPEAKER_PHONE);
      }
    }
  }
   ...
   * Construction.
   */
  public static TribeAudioManager create(Context context) {
    return new TribeAudioManager(context);
  }

  private TribeAudioManager(Context context) {
    Log.d(TAG, "ctor");
    ...
    proximitySensor = TribeProximitySensor.create(context, new Runnable() {
  ...
  public void start(AudioManagerEvents audioManagerEvents) {
    ...
    int result =
        audioManager.requestAudioFocus(audioFocusChangeListener, AudioManager.STREAM_VOICE_CALL,
