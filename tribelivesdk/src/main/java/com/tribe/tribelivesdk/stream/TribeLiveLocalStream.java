...
public class TribeLiveLocalStream {
    ...
    public TribeLiveLocalStream(Context context, PeerView peerView, PeerConnectionFactory peerConnectionFactory) {
        ...
        mediaConstraints = new com.tribe.tribelivesdk.core.MediaConstraints.MediaConstraintsBuilder().build();
    ...
    public void startVideoCapture() {
        if (capturer != null) {
            ...
            capturer.startCapture(mediaConstraints.getMaxWidth(), mediaConstraints.getMaxHeight(), mediaConstraints.getMaxFrameRate());
        }
    }
