...
/**
 * TribeProximitySensor manages functions related to the proximity sensor in
 * the AppRTC demo.
...
public class TribeProximitySensor implements SensorEventListener {
    ...
    private static final String TAG = "TribeProximitySensor";
     ...
     * Construction
     */
    static TribeProximitySensor create(Context context, Runnable sensorStateListener) {
        return new TribeProximitySensor(context, sensorStateListener);
    }

    private TribeProximitySensor(Context context, Runnable sensorStateListener) {
        Log.d(TAG, "TribeProximitySensor" + RTCUtils.getThreadInfo());
