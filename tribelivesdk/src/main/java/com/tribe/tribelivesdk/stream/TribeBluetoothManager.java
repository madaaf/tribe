 ...
 * AppRTC demo.
 */
public class TribeBluetoothManager {

  private static final String TAG = "TribeBluetoothManager";
  ...
  private final TribeAudioManager apprtcAudioManager;
  ...
  private class BluetoothServiceListener implements BluetoothProfile.ServiceListener {
    ...
    @Override
    /** Notifies the client when the proxy object has been disconnected from the service. */ public void onServiceDisconnected(
        int profile) {
      if (profile != BluetoothProfile.HEADSET || bluetoothState == State.UNINITIALIZED) {
        return;
      }
   ...
   * Construction.
   */
  static TribeBluetoothManager create(Context context, TribeAudioManager audioManager) {
    Log.d(TAG, "create" + RTCUtils.getThreadInfo());
    return new TribeBluetoothManager(context, audioManager);
  }

  protected TribeBluetoothManager(Context context, TribeAudioManager audioManager) {
    Log.d(TAG, "ctor");
   ...
   * Note that the TribeAudioManager is also involved in driving this state
   * change.
   */
  public void start() {
    ThreadUtils.checkIsOnMainThread();
    ...
    Log.d(TAG, "HEADSET profile state: " + stateToString(
  ...
  private void bluetoothTimeout() {
    ...
    Log.d(TAG, "bluetoothTimeout: BT state="
        + bluetoothState
        + ", "
        + "attempts: "
        + scoConnectionAttempts
