...
public class Blend {
  ...
  private static class BaseSetup {
    ...
    private BaseSetup(RSToolboxContext bitmapRSContext, Allocation aout,
    ...
    public static BaseSetup createFromBitmap(RenderScript rs, Bitmap srcBitmap, Bitmap dstBitmap) {
      ...
      ScriptIntrinsicBlend blendScript =
          ScriptIntrinsicBlend.create(bitmapRSContext.rs, bitmapRSContext.ain.getElement());
  ...
  private static BlendOp add = new BlendOp() {
    @Override public void runOp(BaseSetup baseSetup) {
